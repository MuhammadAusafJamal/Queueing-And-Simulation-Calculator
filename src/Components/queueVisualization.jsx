...
const QueueVisualization = ({ metrics, numServers, activeQueModel }) => {
    ...
    const serve = activeQueModel === 'M/M/1' ||
        activeQueModel === 'M/M/1 Priority' ||
        activeQueModel === 'M/G/1' ||
        activeQueModel === 'G/G/1' ? 1 : numServers

    return (
        <Card className="mt-8 m-5">
            <CardHeader>
            ...
            <CardContent>
                <div className="flex flex-col md:flex-row items-center justify-center gap-4 py-8">
                    ...
                    <div className="border border-gray-300 rounded-lg p-4 min-w-40 min-h-24 flex items-center justify-center relative">
                        ...
                        <div className="absolute -bottom-3 right-4 bg-white px-2 text-xs font-medium text-gray-500">
                            1/μ: {(1 / (Number(metrics.ws) + Number(metrics.wq))).toFixed(4)}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="mb-2 text-center">
                            ...
                            <div className="text-lg font-bold">{(1 / metrics.ws).toFixed(2)}/unit time</div>
                        </div>
                        <div className="flex -space-x-2">
                            {[...Array(2)].map((_, i) => (
                                <div
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                    <div className="flex flex-col items-center p-4 border rounded-lg">
                        ...
                        <div className="flex items-center mt-1">
                            ...
                            <span className="text-lg font-bold">  {Number(metrics.wq).toFixed(2)}
                            </span>
                        </div>
                    </div>
                    <div className="flex flex-col items-center p-4 border rounded-lg">
                        ...
                        <div className="flex items-center mt-1">
                            ...
                            <span className="text-lg font-bold">  {Number(metrics.ws).toFixed(2)}
                            </span>
                        </div>
                    </div>
                </div>
