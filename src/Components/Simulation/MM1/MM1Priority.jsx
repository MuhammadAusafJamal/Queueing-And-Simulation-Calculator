...
import RandomDataTab from "./MM1PriorityTabs/RandomDataTabMM1";
import GraphicalViewTab from "./MM1PriorityTabs/GraphicalViewTabMM1";
import CalculatedDataTab from "./MM1PriorityTabs/CalculatedDataTabMM1";

//

export const MM1Priority = ({
    setMm1,
    mm1,
    arrivalMean,
    serviceMean,
