...
const CalculatedDataTab = ({ calculatedData, usePriority }) => {
  console.log(calculatedData, "<--------Calculated Data Priority");
  return (
    <div className="overflow-auto">
      ...
      <div className="mt-8">
        <h3 className="text-2xl  font-bold text-center">
          Server Idle Time and Utilization
        </h3>
        <table className="w-full">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td className="py-2 text-center font-bold">
                {calculatedData.serverIdle.toFixed(2) * 100}%
              </td>
              <td className="py-2 text-center font-bold">
                {calculatedData.serverUtilization.toFixed(2) * 100}%
              </td>
            </tr>
          </tbody>
        </table>
